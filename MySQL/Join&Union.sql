...
-- --<< union: can be applies on same datatypes and when no. of select column are same in in left of union and right of union
-- select student_id from marks
-- union
-- select id from students;

-- -- << union all : contains duplicates in it whereas union doesn't have duplicate .
-- select student_id from marks
-- union all
-- select id from students;